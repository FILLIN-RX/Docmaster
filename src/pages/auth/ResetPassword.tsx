              ...
              <div>
                ...
                <div className="relative flex items-center group">
                  ...
                  <input
                    ...
                    className="w-full py-3.5 pl-[42px] pr-[45px] bg-[#faf8f5] border-[1.5px] border-[#E0D5C4] rounded-[14px] font-poppins text-[15px] text-textMain outline-none transition-all focus:border-primary focus:shadow-[0_0_0_4px_rgba(217,138,48,0.15)] focus:bg-white placeholder:text-[#c4bab0]"
                    required
                  />
                  <button
                    type="button"
              ...
              <div>
                ...
                <div className="relative flex items-center group">
                  ...
                  <input
                    ...
                    className="w-full py-3.5 pl-[42px] pr-4 bg-[#faf8f5] border-[1.5px] border-[#E0D5C4] rounded-[14px] font-poppins text-[15px] text-textMain outline-none transition-all focus:border-primary focus:shadow-[0_0_0_4px_rgba(217,138,48,0.15)] focus:bg-white placeholder:text-[#c4bab0]"
                    required
                  />
                </div>
