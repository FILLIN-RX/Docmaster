...
export default function DocumentDetailModal({
  ...
  const currentImage = activeTab === "recto" ? doc.photo_recto : doc.photo_verso;
  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-50 flex items-end md:items-center justify-center p-0 md:p-4">
        <div className="w-full md:max-w-6xl md:rounded-3xl md:shadow-2xl bg-white flex flex-col md:flex-row h-full md:h-auto max-h-screen md:max-h-[90vh] overflow-hidden animate-in fade-in slide-in-from-bottom-10 md:slide-in-from-bottom-0">
          ...
          <div className="flex-1 flex flex-col h-auto md:h-full bg-white overflow-hidden">
                    ...
                    <div className="flex items-center gap-1.5">
                      {doc.is_verified ? (
                        <span className="inline-flex items-center gap-1 px-2 py-0.5 bg-emerald-50 text-emerald-700 rounded-full text-[9px] font-black uppercase tracking-wider border border-emerald-200">
                          <i className="fa-solid fa-shield-check" /> Certifié
                        </span>
                      ) : (
            ...
            <div className="flex-1 overflow-y-auto px-4 md:px-8 py-6 space-y-6">
              ...
              <div className="text-[11px] text-slate-500 space-y-1 pt-4 border-t border-slate-100">
                <p>
                  <span className="font-semibold">ID:</span> {doc.id?.substring(0, 8)}...
                </p>
                <p>
