...
export default function ShareModal({ doc, onClose }: ShareModalProps) {
  ...
  return (
    <Modal opened onClose={onClose} size="md" withCloseButton={false} padding="xl">
      <div className="flex items-start gap-4 mb-8">
        <div className="w-12 h-12 rounded-xl bg-slate-50 border border-slate-100 flex items-center justify-center text-slate-900">
