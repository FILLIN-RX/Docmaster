...
export default function PaymentModal({
  ...
  return (
    <Modal opened={isOpen} onClose={onClose} size="md" withCloseButton={false} padding="lg">
      <h2 className="font-bricolage text-lg font-black text-textMain mb-1">{title || t("payment_title")}</h2>
              ...
              <div className="p-3 border-2 rounded-[14px] border-gray-200 bg-gray-50 opacity-60 cursor-not-allowed">
                   <div className="flex items-center gap-3">
                      <div className="w-10 h-10 rounded-[10px] bg-gray-400 flex items-center justify-center">
                          <i className="fa-solid fa-credit-card text-white" />
                      </div>
                      <div className="flex-1">
