  ...
  return (
    <Modal opened onClose={onClose} size="sm" withCloseButton={false} padding="xl">
      <div className="text-center">
        ...
        <p className="text-[13.5px] text-textMuted leading-relaxed mb-6">
          {t("confirm_declaration_desc")}
        </p>

        <div className="bg-orange-50 border-2 border-orange-100 rounded-2xl p-4 mb-8 text-left">
          <p className="text-[11.5px] text-orange-900 leading-relaxed font-bold">
            <i className="fa-solid fa-circle-info text-orange-500 mr-2" />
        ...
        <div className="mb-8">
          <div className="relative">
            <i className="fa-solid fa-lock text-primary absolute left-4 top-1/2 -translate-y-1/2" />
            <input
              type="password"
              value={password}
          ...
          {passwordError && (
            <p className="text-[11px] text-red-500 mt-2 font-bold">
              <i className="fa-solid fa-xmark-circle mr-1" />
